namespace SuperPutty
{
    partial class ctlPuttyPanel
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.newSessionToolStripMenuItem.Size = new System.Drawing.Size(143, 22);
        	this.newSessionToolStripMenuItem.Text = "New Session";
        	this.newSessionToolStripMenuItem.Click += new System.EventHandler(this.NewSessionToolStripMenuItemClick);
        	// 
        	// duplicateSessionToolStripMenuItem
        	// 
        	this.duplicateSessionToolStripMenuItem.Name = "duplicateSessionToolStripMenuItem";
        	this.duplicateSessionToolStripMenuItem.Size = new System.Drawing.Size(143, 22);
        	this.duplicateSessionToolStripMenuItem.Text = "Duplicate Session";
        	this.duplicateSessionToolStripMenuItem.Click += new System.EventHandler(this.DuplicateSessionToolStripMenuItemClick);
        	// 
        	// toolStripSeparator3
        	// 
        	...
        	this.clearScrollbackToolStripMenuItem.Size = new System.Drawing.Size(143, 22);
        	this.clearScrollbackToolStripMenuItem.Text = "Clear Scrollback";
        	this.clearScrollbackToolStripMenuItem.Click += new System.EventHandler(this.ClearScrollbackToolStripMenuItemClick);
        	// 
        	// resetTerminalToolStripMenuItem
        	// 
        	this.resetTerminalToolStripMenuItem.Name = "resetTerminalToolStripMenuItem";
        	this.resetTerminalToolStripMenuItem.Size = new System.Drawing.Size(143, 22);
        	this.resetTerminalToolStripMenuItem.Text = "Reset Terminal";
        	this.resetTerminalToolStripMenuItem.Click += new System.EventHandler(this.ResetTerminalToolStripMenuItemClick);
        	// 
        	// toolStripSeparator2
        	// 
        	...
        	this.aboutPuttyToolStripMenuItem.Size = new System.Drawing.Size(143, 22);
        	this.aboutPuttyToolStripMenuItem.Text = "About Putty";
        	this.aboutPuttyToolStripMenuItem.Click += new System.EventHandler(this.AboutPuttyToolStripMenuItemClick);
        	// 
        	// ctlPuttyPanel
        	// 
