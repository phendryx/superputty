...
namespace SuperPutty.Classes
{
    ...
    public class Database
    {
        ...
        public SQLiteConnection Open()
        {
            ...
            try
            {
                string db_folder = Path.Combine(Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), "SuperPutty");
                if (!Directory.Exists(db_folder))
                {
                    Directory.CreateDirectory(db_folder);
                }

                db_filename = Path.Combine(Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), "SuperPutty\\SuperPutty.db3");
